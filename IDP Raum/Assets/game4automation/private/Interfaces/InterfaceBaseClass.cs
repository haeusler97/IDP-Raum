...
namespace game4automation
{
    public class InterfaceBaseClass : Game4AutomationBehavior
    {
        ...
        public void AddSignal(InterfaceSignal interfacesignal)
        {
        ...
        public virtual void BeforeUpdateAllSignals()
        {
        }

        public virtual void AfterUpdateAllSignals()
        {
        }

        public virtual void UpdateSignal(InterfaceSignal interfacesignal)
        {
        }
